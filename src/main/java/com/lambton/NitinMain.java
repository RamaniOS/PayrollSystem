...
public class NitinMain {
    public static void main(String[] args) {
        ...
        MotorCycle mC2 = new MotorCycle("motorcycle", "Honda", "IOP23W", "Sports", insuranceDate1, 23.0f, 26000.00f, 1, "petrol");
        mC2.printMyData();

        LocalDate insuranceDate3 = LocalDate.parse("2018-12-03");
        MotorCycle mC3 = new MotorCycle("motorcycle", "Honda", "IOP23W", "Sports", insuranceDate1, 23.0f, 26000.00f, 1, "petrol");
        mC3.printMyData();
