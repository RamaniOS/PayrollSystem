...
public class MainClass {
    ...
    public static void main(String[] args)
    {
        ...
        EmployeeClass fP6 = new FixedBasedPartTimeEmployee("Jyhn", 24, 30.0f, 10, 40.0f);
        fP6.printMyData();
        MotorCycle mC6 = new MotorCycle("N/A", null, null, null, null, 0.00f, 0.00f, 0, null);
        mC6.printMyDisplay();

        System.out.println("*-------------------------------------------------------------------------*");
        EmployeeClass fP7 = new FixedBasedPartTimeEmployee("Jyhn", 24, 30.0f, 10, 40.0f);
        fP7.printMyData();
        MotorCycle mC7 = new MotorCycle("N/A", null, null, null, null, 0.00f, 0.00f, 0, null);
        mC7.printMyDisplay();

        System.out.println("*-------------------------------------------------------------------------*");
        EmployeeClass fP8 = new FixedBasedPartTimeEmployee("Jyhn", 24, 30.0f, 10, 40.0f);
        fP8.printMyData();
        MotorCycle mC8 = new MotorCycle("N/A", null, null, null, null, 0.00f, 0.00f, 0, null);
        mC8.printMyDisplay();
